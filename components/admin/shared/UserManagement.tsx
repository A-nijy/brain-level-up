...
import { StyleSheet, FlatList, ActivityIndicator, TouchableOpacity, TextInput, View as RNView } from 'react-native';
...
const SharedRow = ({ item, index, colors, onToggleHide, onDelete, router }: {
    ...
    return (
        ...
        >
            ...
            <View variant="transparent" style={[styles.col, { flex: 1.2, justifyContent: 'flex-end', gap: 8 }]}>
                ...
                >
                    <FontAwesome name="eye" size={14} color={colors.tint} />
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                    <FontAwesome
                        name={item.is_hidden ? "check" : "eye-slash"}
                        size={14}
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View variant="transparent" style={styles.emptyTable}>
                            <Text style={[styles.emptyText, { color: colors.textSecondary }]}>{Strings.common.noData}</Text>
                        </View>
                    }
                />
            </Card>
